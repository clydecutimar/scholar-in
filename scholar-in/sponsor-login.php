...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT id, Username, Password FROM sponsor WHERE Username = :username");
    ...
    if ($user && password_verify($password, $user["Password"])) {
        ...
        header("Location: sponsor-portal.php"); // Redirect to a dashboard page
        exit();
    } else {
        // Invalid login
...
<head>
    ...
    <title>ScholarIN - Sponsor Login</title>
</head>
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-lg-8 col-xl-6">
                <div class="card rounded-3">
                    <img src="https://scholarshipinstitute.org/wp-content/uploads/2022/04/how-to-start-scholarship-fund.jpg"
                         class="w-100"
                         style="border-top-left-radius: .3rem; border-top-right-radius: .3rem;"
                         alt="Sample photo">

                    <div style="display: flex; justify-content: center; align-items: center;">
                        <br> <br> <a href="home.html"> <svg width="116" height="22" viewBox="0 0 116 22" fill="none"
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="sponsor-login.php" method="POST">
                            <div class="mb-3">
